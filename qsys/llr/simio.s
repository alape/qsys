...
.text_llr
    simio_puts:
        ...
        _putwloop:  st r3, @SIMIO_OFFSET + 1 ; output current word via SIMIO (its first byte will be printed)
    ...
    simio_getc:
        ...
        _getcloop:  ld r1, @SIMIO_OFFSET + 2 ; wait until SIMI is not zero
                    beq r0, r1, 0
    ...
    simio_trap_exit:
        ...
        ld r0, 1
        st r0, @SIMIO_OFFSET + 3              ; store 1 to TRAP
